...
class TenantDatabaseManager
{
    ...
    /**
     * Original .env mysql credentials — never use a previously switched tenant's config as fallback.
     *
    ...
    /**
     * Point the default mysql connection at this tenant's shard database.
     */
    public function switchForTenant(Tenant $tenant, string $module = 'workspace'): void
    {
