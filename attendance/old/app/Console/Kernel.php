...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // TimeStation Sync & Processing
        $schedule->command('attendance:sync-timestation')->hourly();
        $schedule->command('attendance:process-timestation')->hourlyAt(15);
        $schedule->command('attendance:calculate-monthly-overtime')->monthlyOn(1, '02:00'); // Run on 1st of next month
