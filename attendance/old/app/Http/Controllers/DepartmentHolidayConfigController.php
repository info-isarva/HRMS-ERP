...
class DepartmentHolidayConfigController extends Controller
{
    ...
    {
        $selectedYear = $request->get('financial_year', active_fy_label());
        ...
        $financialYears = \App\Models\FinancialYear::orderBy('start_date', 'desc')->pluck('name', 'name');
    ...
    {
        $financialYear = $request->get('financial_year', active_fy_label());
