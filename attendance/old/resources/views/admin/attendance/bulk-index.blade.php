                ...
                <form action="{{ route('admin.attendance.preview') }}" method="GET" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2 md:col-span-2">
                            <label for="mode" class="block text-sm font-semibold text-gray-700 flex items-center">
                                <i class="fas fa-cog text-indigo-500 mr-2"></i>
                                Processing Mode
                            </label>
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <!-- General Mode -->
                                <label class="relative flex cursor-pointer rounded-xl border-2 border-gray-200 bg-white p-4 shadow-sm focus:outline-none transition-all hover:border-indigo-300 has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                    <input type="radio" name="mode" value="general" class="sr-only" checked>
                                    <span class="flex flex-1">
                                        <span class="flex flex-col">
                                            <span class="block text-sm font-bold text-gray-900">General Mode</span>
                                            <span class="mt-1 flex items-center text-xs text-gray-500">Based on leaves and holidays only</span>
                                        </span>
                                    </span>
                                    <i class="fas fa-file-alt text-indigo-600 ml-3"></i>
                                </label>

                                <!-- Biometric Mode -->
                                <label class="relative flex cursor-pointer rounded-xl border-2 border-gray-200 bg-white p-4 shadow-sm focus:outline-none transition-all hover:border-indigo-300 has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                    <input type="radio" name="mode" value="biometric" class="sr-only">
                                    <span class="flex flex-1">
                                        <span class="flex flex-col">
                                            <span class="block text-sm font-bold text-gray-900">Biometric Mode</span>
                                            <span class="mt-1 flex items-center text-xs text-gray-500">Using biometric device data</span>
                                        </span>
                                    </span>
                                    <i class="fas fa-fingerprint text-indigo-600 ml-3"></i>
                                </label>

                                <!-- TimeStation Mode -->
                                <label class="relative flex cursor-pointer rounded-xl border-2 border-gray-200 bg-white p-4 shadow-sm focus:outline-none transition-all hover:border-indigo-300 has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                    <input type="radio" name="mode" value="timestation" class="sr-only">
                                    <span class="flex flex-1">
                                        <span class="flex flex-col">
                                            <span class="block text-sm font-bold text-gray-900">TimeStation Mode</span>
                                            <span class="mt-1 flex items-center text-xs text-gray-500">Sync from TimeStation API</span>
                                        </span>
                                    </span>
                                    <i class="fas fa-clock text-indigo-600 ml-3"></i>
                                </label>

                                <!-- Portal Attendance Mode -->
                                <label class="relative flex cursor-pointer rounded-xl border-2 border-gray-200 bg-white p-4 shadow-sm focus:outline-none transition-all hover:border-indigo-300 has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                    <input type="radio" name="mode" value="portal_attendance" class="sr-only">
                                    <span class="flex flex-1">
                                        <span class="flex flex-col">
                                            <span class="block text-sm font-bold text-gray-900">Portal Attendance</span>
                                            <span class="mt-1 flex items-center text-xs text-gray-500">Punch via employee portal (IP/GPS)</span>
                                        </span>
                                    </span>
                                    <i class="fas fa-globe text-indigo-600 ml-3"></i>
                                </label>
                            </div>
                        </div>
                    </div>
