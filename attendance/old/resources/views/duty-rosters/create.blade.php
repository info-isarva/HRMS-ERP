...
@section('title', 'Create Duty Roster - HRMS')
...
<div class="p-6 space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h1 class="text-2xl font-bold text-white">Create Duty Roster</h1>
                        <p class="text-blue-100 text-sm mt-2">Assign employee to a shift on specific date</p>
                    </div>
                </div>
    ...
    <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
        <form action="{{ route('duty-rosters.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select id="employee_payroll_id"
                            ...
                            @foreach($employees as $employee)
                                <option value="{{ $employee->payroll_id }}" {{ old('employee_payroll_id') == $employee->payroll_id ? 'selected' : '' }}>
                ...
                <!-- Shift Preview -->
                <div id="shift-preview" class="bg-gray-50 rounded-lg p-4 hidden">
                    <h3 class="text-sm font-medium text-gray-700 mb-2">Shift Details</h3>
                    <div id="shift-details" class="text-sm text-gray-600"></div>
                </div>
            </div>
