...
<div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('reports.employee-monthly') }}" class="block group">
         ...
         <!-- LOP Report -->
        <a href="{{ route('reports.leave-lop') }}" class="block group">
            <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden h-full">
                <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="bg-gradient-to-br from-orange-500 to-red-600 w-12 h-12 rounded-lg flex items-center justify-center shadow-md transform group-hover:scale-110 transition-transform duration-300">
                            <i class="fas fa-hand-holding-usd text-white text-xl"></i>
                        </div>
                        <span class="bg-orange-100 text-orange-700 text-xs px-2 py-1 rounded-full font-medium">Payroll</span>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-orange-600 transition-colors mb-2">LOP Report</h3>
                    <p class="text-sm text-gray-500 mb-4 line-clamp-2">
                        Analyze leave applications involving Loss of Pay (LOP) for payroll processing.
                    </p>
                </div>
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between group-hover:bg-orange-50 transition-colors">
                    <span class="text-sm font-medium text-gray-600 group-hover:text-orange-700">View Report</span>
                    <i class="fas fa-arrow-right text-gray-400 group-hover:text-orange-600 transform group-hover:translate-x-1 transition-all"></i>
                </div>
            </div>
        </a>
        
         <!-- Daily Leave Schedule Report -->
        <a href="{{ route('reports.daily-leave') }}" class="block group">
            <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden h-full">
                <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="bg-gradient-to-br from-yellow-500 to-amber-600 w-12 h-12 rounded-lg flex items-center justify-center shadow-md transform group-hover:scale-110 transition-transform duration-300">
                            <i class="fas fa-calendar-alt text-white text-xl"></i>
                        </div>
                        <span class="bg-amber-100 text-amber-700 text-xs px-2 py-1 rounded-full font-medium">Schedule</span>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-amber-600 transition-colors mb-2">Daily Leave Schedule</h3>
                    <p class="text-sm text-gray-500 mb-4 line-clamp-2">
                        Track all active leave applications for any specific date, excluding rejected ones.
                    </p>
                </div>
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between group-hover:bg-amber-50 transition-colors">
                    <span class="text-sm font-medium text-gray-600 group-hover:text-amber-700">View Report</span>
                    <i class="fas fa-arrow-right text-gray-400 group-hover:text-amber-600 transform group-hover:translate-x-1 transition-all"></i>
                </div>
            </div>
        </a>
