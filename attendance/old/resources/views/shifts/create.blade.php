...
@section('title', 'Create Shift - HRMS')
            ...
            <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-8 py-12 relative overflow-hidden">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="ml-6">
                            <h1 class="text-3xl font-bold text-white mb-2">Create New Shift</h1>
                            <p class="text-indigo-100 text-lg">
                                Add a new work shift with timing details
                            </p>
                        </div>
                    </div>
            ...
            <div class="px-8 py-6 border-b border-gray-200/50 bg-gradient-to-r from-gray-50/50 to-blue-50/30">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Enter the details for your new shift</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-2">
                            <div class="relative">
                                <input type="text"
                                       ...
                                       readonly
                                       value="{{ old('start_time') ? date('g:i A', strtotime(old('start_time'))) : '9:00 AM' }}"
                        ...
                        <div class="space-y-2">
                            <div class="relative">
                                <input type="text"
                                       id="end_time_display"
                                       readonly
                                       value="{{ old('end_time') ? date('g:i A', strtotime(old('end_time'))) : '5:00 PM' }}"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <textarea id="description"
                                  ...
                                  placeholder="Enter description for this shift...">{{ old('description') }}</textarea>
...
function openClockPicker(inputId) {
    ...
    const hiddenInput = document.getElementById(inputId);
    const currentValue = hiddenInput.value || '09:00';
