...
@section('title', 'Department API Connection Test - HRMS')
@section('page-title', 'Department API Connection Test')

@section('content')
<div class="p-6 space-y-6">
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-green-600 via-teal-600 to-blue-600 rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-bold mb-3 flex items-center">
                        ...
                        Department API Connection Test
                    </h1>
                    <p class="text-green-100 text-lg">Test connection to the payroll system for department data</p>
                </div>
                <div class="hidden lg:block">
                    <div class="w-36 h-36 bg-white bg-opacity-15 rounded-full flex items-center justify-center">
                        <i class="fas fa-sitemap text-5xl text-white"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 mt-2">
                        @if($isConnected)
                            The system was able to connect to the Payroll API and retrieve department data.
                        @else
            ...
            <div class="mt-8 flex space-x-4">
                <a href="{{ route('admin.department-sync') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
                    <i class="fas fa-arrow-left mr-2"></i>
                    Back to Sync Dashboard
                </a>

                <button type="button" onclick="location.reload()" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors">
