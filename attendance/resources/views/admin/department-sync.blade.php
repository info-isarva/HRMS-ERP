...
<div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between">
                <div class="w-full lg:w-auto mb-4 lg:mb-0">
                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 flex items-center">
                        <i class="fas fa-building mr-2 sm:mr-4 text-lg sm:text-xl"></i>
                        <span class="text-lg sm:text-xl lg:text-2xl">Department Synchronization</span>
                    </h1>
                    <p class="text-blue-100 text-sm sm:text-base lg:text-lg">Synchronize departments from the payroll system</p>
                </div>
                <div class="hidden lg:block">
                    <div class="w-24 h-24 sm:w-32 sm:h-32 lg:w-36 lg:h-36 bg-white bg-opacity-15 rounded-full flex items-center justify-center">
                        <i class="fas fa-sitemap text-3xl sm:text-4xl lg:text-5xl text-white"></i>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <h3 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
                <i class="fas fa-plug text-green-600 mr-2 sm:mr-3 text-sm sm:text-base"></i>
        ...
        <div class="p-4 sm:p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-gray-500 text-sm sm:text-base mt-1">
                        @if($apiConnected)
                            Successfully connected to the payroll API. Department data is available for synchronization.
                        @else
            ...
            <div class="mt-4 sm:mt-6">
                <a href="{{ route('admin.department-sync.test') }}" class="inline-flex items-center px-3 sm:px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors text-sm sm:text-base">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <h3 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
                <i class="fas fa-chart-bar text-green-600 mr-2 sm:mr-3 text-sm sm:text-base"></i>
        ...
        <div class="p-4 sm:p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div class="bg-green-50 border border-green-100 rounded-lg p-4 sm:p-5">
                    <h4 class="text-base sm:text-lg font-medium text-gray-900 mb-2">API Departments</h4>
                    <div class="flex items-center">
                        <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-cloud-download-alt text-green-600 text-lg sm:text-2xl"></i>
                        </div>
                        <div class="ml-3 sm:ml-4">
                            <p class="text-2xl sm:text-3xl font-bold text-green-600">{{ $stats['api_departments_count'] }}</p>
                            <p class="text-gray-500 text-sm sm:text-base">Departments in payroll system</p>
                        </div>
                    </div>
                </div>

                <div class="bg-blue-50 border border-blue-100 rounded-lg p-4 sm:p-5">
                    <h4 class="text-base sm:text-lg font-medium text-gray-900 mb-2">System Departments</h4>
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 sm:ml-4">
                            <p class="text-2xl sm:text-3xl font-bold text-blue-600">{{ $stats['system_departments_count'] }}</p>
                            <p class="text-gray-500 text-sm sm:text-base">Departments in HRMS</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <h3 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
                <i class="fas fa-cog text-green-600 mr-2 sm:mr-3 text-sm sm:text-base"></i>
        ...
        <div class="p-4 sm:p-6">
            <div class="space-y-4">
                <p class="text-gray-700 text-sm sm:text-base">
                    ...
                    This process will create, update, and optionally remove departments based on the payroll system data.
                </p>

                <!-- Sync Status Information -->
                @if($stats['api_departments_count'] !== $stats['system_departments_count'])
                        ...
                        <div class="flex items-start sm:items-center">
                            ...
                            <div>
                                ...
                                <p class="text-orange-700 text-xs sm:text-sm mt-1">
                                    Department count mismatch detected ({{ abs($stats['api_departments_count'] - $stats['system_departments_count']) }} departments).
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
                    <p class="text-blue-800 text-sm sm:text-base">
                        ...
                        The synchronization preserves all existing department data while ensuring consistency with the payroll system.
                    </p>
                </div>

                <form action="{{ route('admin.department-sync.sync') }}" method="POST" class="mt-4 sm:mt-6 space-y-4">
                    @csrf
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <input type="checkbox" id="force_update" name="force_update" value="1" class="h-4 w-4 sm:h-5 sm:w-5 text-green-600 rounded border-gray-300 focus:ring-green-500">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="delete_extra" name="delete_extra" value="1" class="h-4 w-4 sm:h-5 sm:w-5 text-red-600 rounded border-gray-300 focus:ring-red-500">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                        <button type="submit" class="inline-flex items-center justify-center px-4 sm:px-5 py-2 sm:py-2.5 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors text-sm sm:text-base">
                            <i class="fas fa-sync-alt mr-2 text-sm sm:text-base"></i>
                            Start Comprehensive Sync
                        </button>

                        <a href="{{ route('admin.department-sync.test') }}" class="inline-flex items-center justify-center px-4 sm:px-5 py-2 sm:py-2.5 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-lg transition-colors text-sm sm:text-base">
                            <i class="fas fa-network-wired mr-2 text-sm sm:text-base"></i>
                            Test API Connection
                        </a>
                    </div>
    ...
    <!-- Data Tables -->
    @if($apiConnected && count($apiDepartments) > 0 || count($systemDepartments) > 0)
    <div class="flex flex-col lg:flex-row gap-4 sm:gap-6">
        <!-- System Departments -->
        @if(count($systemDepartments) > 0)
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden flex-1">
            <div class="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
                    <i class="fas fa-building text-green-600 mr-2 sm:mr-3 text-sm sm:text-base"></i>
                    <span class="text-sm sm:text-base lg:text-lg">System Departments ({{ count($systemDepartments) }})</span>
                </h3>
            </div>
            ...
            <div class="p-4 sm:p-6 overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($systemDepartments as $department)
                        <tr>
        ...
        <!-- Sample API Data -->
        @if($apiConnected && count($apiDepartments) > 0)
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden flex-1">
            <div class="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                <h3 class="text-lg sm:text-xl font-semibold text-gray-900 flex items-center">
                    <i class="fas fa-table text-green-600 mr-2 sm:mr-3 text-sm sm:text-base"></i>
                    <span class="text-sm sm:text-base lg:text-lg">Sample API Data ({{ min(5, count($apiDepartments)) }} of {{ count($apiDepartments) }})</span>
                </h3>
            </div>
            ...
            <div class="p-4 sm:p-6 overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach(array_slice($apiDepartments, 0, 5) as $department)
                        <tr>
                            <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-xs sm:text-sm font-medium text-gray-900">
                                {{ $department['id'] ?? 'N/A' }}
                            </td>
