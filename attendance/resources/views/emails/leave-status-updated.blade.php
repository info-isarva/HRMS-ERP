    ...
    <div class="container">
        ...
        <div class="content">
            <div class="status-info status-{{ str_replace('_', '-', $status) }}">
                ...
                @if($status == 'approved')
                    <p>Great news! Your leave application has been <strong>approved</strong> and is now confirmed.</p>
                @elseif($status == 'rejected')
            ...
            <div style="background-color: #ecfdf5; border: 1px solid #bbf7d0; border-radius: 6px; padding: 12px; margin-top: 15px;">
                <p style="margin: 0; color: #14532d; font-size: 13px;">
                    <strong>🎉 Congratulations!</strong> Your leave has been approved. Please ensure proper handover of responsibilities before your leave period. 
                    Enjoy your time off!
                </p>
            </div>
            @elseif($status == 'rejected')
