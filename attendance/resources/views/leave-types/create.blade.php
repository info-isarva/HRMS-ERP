...
@section('title', 'Create Leave Type - HRMS')

@section('page-title', 'Create Leave Type')
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h1 class="text-2xl font-bold text-white">Create Leave Type</h1>
                        <p class="text-blue-100 text-sm mt-2">Add a new leave type and assign it to departments</p>
                    </div>
                </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="financial_year" 
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                required>
                            <option value="2025-2026" {{ old('financial_year') == '2025-2026' ? 'selected' : '' }}>2025-2026</option>
                            <option value="2026-2027" {{ old('financial_year') == '2026-2027' ? 'selected' : '' }}>2026-2027</option>
                            <option value="2027-2028" {{ old('financial_year') == '2027-2028' ? 'selected' : '' }}>2027-2028</option>
                        </select>
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                              placeholder="Enter description for this leave type...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
