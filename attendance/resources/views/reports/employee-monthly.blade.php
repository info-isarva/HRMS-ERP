...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="{{ route('reports.employee-monthly') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
            ...
            <div>
                <button type="submit" class="w-full h-11 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-lg transition-all shadow-md hover:shadow-lg flex items-center justify-center">
