...
@section('title', 'POSH Policy Distribution Auditing')
...
<div class="page-wrapper">
    <div class="content container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center position-relative">
                    <div class="d-flex align-items-center">
                        <div class="page-header-icon-box">
                            <i class="fas fa-file-signature fa-lg" style="color: rgba(255,255,255,0.9);"></i>
                        </div>
                        <div class="ms-3">
                            <h1 class="page-header-title" style="margin-left: 1rem;">POSH Auditing</h1>
                            <p class="page-header-subtitle" style="margin-left: 1rem;">Track and audit employee digital policy acknowledgments and consent logs</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="p-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">POSH Auditing</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="filter-card">
            <form method="GET" action="{{ route('compliance.posh.policy-distribution') }}">
                <div class="row align-items-end">
                    ...
                    <div class="col-xl-5 col-lg-4 col-md-12 col-12 mb-3">
                        <div class="btn-group-responsive d-flex justify-content-start">
                            ...
                            <a href="{{ route('compliance.posh.policy-distribution') }}" class="btn btn-secondary flex-fill" style="min-width: 120px;">
        ...
        <div class="table-card">
            <div class="table-responsive">
                <table class="table table-hover desktop-table" id="poshTable">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Employee</th>
