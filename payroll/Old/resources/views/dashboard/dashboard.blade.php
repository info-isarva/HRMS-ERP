                        ...
                        <div class="row" id="financialMetrics">
                            <div class="col-md-4 col-sm-4 col-12 mb-2">
                                <div class="financial-metric">
                                    <h4 class="financial-amount" id="grossPayAmount">{{ format_currency($financialOverview['current_month']->total_gross ?? 0) }}</h4>
                                    <div class="financial-label">Gross Pay</div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-12 mb-2">
                                <div class="financial-metric">
                                    <h4 class="financial-amount" id="deductionsAmount">{{ format_currency($financialOverview['current_month']->total_deductions ?? 0) }}</h4>
                                    <div class="financial-label">Deductions</div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-12 mb-2">
                                <div class="financial-metric">
                                    <h4 class="financial-amount" id="netPayAmount">{{ format_currency($financialOverview['current_month']->total_net ?? 0) }}</h4>
...
<script>
    ...
    function updateFinancialMetrics(financialData) {
        ...
        if (grossPayElement) {
            ...
            grossPayElement.textContent = globalCurrencySymbol + ' ' + new Intl.NumberFormat(window.globalCurrencyLocale).format(grossAmount);
        }
        ...
        if (deductionsElement) {
            ...
            deductionsElement.textContent = globalCurrencySymbol + ' ' + new Intl.NumberFormat(window.globalCurrencyLocale).format(deductionsAmount);
        }
        ...
        if (netPayElement) {
            ...
            netPayElement.textContent = globalCurrencySymbol + ' ' + new Intl.NumberFormat(window.globalCurrencyLocale).format(netAmount);
        }
    }
                    ...
                    chartConfig.options.plugins.datalabels = {
                        ...
                        formatter: function(value, context) {
                            ...
                            if (context.dataset.label && context.dataset.label.includes('Amount')) {
                                return globalCurrencySymbol + (value >= 1000 ? (value/1000).toFixed(0) + 'K' : value);
                            }
                            return value;
                        }
                    };
                    ...
                    y: {
                        ...
                        ticks: {
                            callback: function(value) {
                                return globalCurrencySymbol + (value / 1000).toFixed(0) + 'K';
                            }
                        }
                    }
                }
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                ...
                                return context.dataset.label + ': ' + globalCurrencySymbol + (value / 1000).toFixed(0) + 'K';
                            }
                        }
                    }
                },
