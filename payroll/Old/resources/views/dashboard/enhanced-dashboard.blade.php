                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="financial-metric">
                                        <h4 class="financial-amount">{{ get_currency_symbol() }}{{ number_format($financialOverview['current_month']->total_gross ?? 0) }}</h4>
                                        <div class="financial-label">Gross Pay</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="financial-metric">
                                        <h4 class="financial-amount">{{ get_currency_symbol() }}{{ number_format($financialOverview['current_month']->total_deductions ?? 0) }}</h4>
                                        <div class="financial-label">Deductions</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="financial-metric">
                                        <h4 class="financial-amount">{{ get_currency_symbol() }}{{ number_format($financialOverview['current_month']->total_net ?? 0) }}</h4>
