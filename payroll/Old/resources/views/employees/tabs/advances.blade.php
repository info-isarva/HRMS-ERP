                        ...
                        <table class="table table-hover table-center mb-0" id="advancesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ get_currency_symbol() }}{{ number_format($advance->advance_amount, 2) }}</td>
                                    <td>{{ get_currency_symbol() }}{{ number_format($advance->monthly_deduction, 2) }}</td>
                                    <td>
                                        <div class="d-flex flex-column small">
                                            <span class="text-success">Paid: {{ get_currency_symbol() }}{{ number_format($advance->total_deducted ?? 0, 2) }}</span>
                                            <span class="text-danger">Left: {{ get_currency_symbol() }}{{ number_format($advance->remaining_amount ?? 0, 2) }}</span>
                                        </div>
                                    </td>
                                    <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-light" id="add_calculated_deduction" placeholder="{{ get_currency_symbol() }}0.00" readonly>
                            </div>
                        </div>
            ...
            <form id="editAdvanceForm">
                <div class="modal-body">
                    ...
                    <div class="form-group bg-light p-3 rounded">
                        ...
                        <h4 class="mb-0 text-info font-weight-bold" id="edit_calculated_deduction">{{ get_currency_symbol() }}0.00</h4>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card bg-light border-0 h-100 mb-0">
                            <div class="card-body text-center p-3">
                                ...
                                <h3 class="font-weight-bold text-dark mb-0" id="view_total_amount">{{ get_currency_symbol() }}0.00</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card bg-success-light border-0 h-100 mb-0">
                            <div class="card-body text-center p-3">
                                ...
                                <h3 class="font-weight-bold text-success mb-0" id="view_paid_amount">{{ get_currency_symbol() }}0.00</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card bg-danger-light border-0 h-100 mb-0">
                            <div class="card-body text-center p-3">
                                ...
                                <h3 class="font-weight-bold text-danger mb-0" id="view_remaining_amount">{{ get_currency_symbol() }}0.00</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            fetch(`{{ url('advance') }}/${id}/history`)
                ...
                .then(data => {
                    if(data.success) {
                        ...
                        // Populate Cards
                        $('#view_total_amount').text('{{ get_currency_symbol() }}' + Number(adv.amount).toLocaleString('en-IN', { minimumFractionDigits: 2 }));
                        $('#view_paid_amount').text('{{ get_currency_symbol() }}' + Number(adv.total_paid || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 }));
                        $('#view_remaining_amount').text('{{ get_currency_symbol() }}' + Number(adv.remaining || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 }));
                        ...
                        $('#view_monthly_emi').text('{{ get_currency_symbol() }}' + Number(adv.monthly_deduction).toLocaleString('en-IN', { minimumFractionDigits: 2 }));
                            ...
                            deductions.forEach((d, index) => {
                                ...
                                rows += `
                                    <tr>
                                        ...
                                        <td class="text-danger font-weight-bold">-{{ get_currency_symbol() }}${Number(d.amount).toFixed(2)}</td>
                                        <td>${type}</td>
        ...
        function calculateDeduction(amountVal, tenureVal, displayElement) {
            ...
            if (tenure > 0) {
                ...
                if (displayElement.tagName === 'INPUT') {
                    displayElement.value = '{{ get_currency_symbol() }}' + deduction.toFixed(2);
                } else {
                    displayElement.innerText = '{{ get_currency_symbol() }}' + deduction.toFixed(2);
                }
            } else {
                console.log('Tenure is 0 or invalid, setting to 0.00');
                if (displayElement.tagName === 'INPUT') {
                    displayElement.value = '{{ get_currency_symbol() }}0.00';
                } else {
                    displayElement.innerText = '{{ get_currency_symbol() }}0.00';
                }
            }
        }
