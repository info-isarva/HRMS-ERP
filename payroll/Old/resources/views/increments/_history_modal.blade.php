                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $loop->first ? 'table-success' : '' }}">
                                ...
                                <td>{{ get_currency_symbol() }}{{ number_format($history->previous_ctc, 2) }}</td>
                                <td><strong class="text-success">{{ get_currency_symbol() }}{{ number_format($history->new_ctc, 2) }}</strong></td>
                                <td>
                                    <span class="badge bg-primary">
                                        +{{ get_currency_symbol() }}{{ number_format($history->increment_amount, 2) }}
