                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tfoot class="table-success">
                                        <tr>
                                            ...
                                            <th class="text-end" id="current_net_pay">{{ get_currency_symbol() }} 0.00</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                    ...
                    <div class="card shadow border-success">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label fw-bold text-success"><i class="fas fa-money-bill-wave me-1"></i>New Annual CTC</label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tfoot class="table-success">
                                        <tr>
                                            <th>Net Monthly Pay</th>
                                            <th class="text-end fw-bold text-success" id="new_net_pay">{{ get_currency_symbol() }} 0.00</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
