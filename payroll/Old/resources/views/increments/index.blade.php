                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Previous CTC
                                                <span class="fw-bold">{{ get_currency_symbol() }}{{ number_format($inc->previous_ctc, 2) }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Increment Amount
                                                <span class="fw-bold text-success">+{{ get_currency_symbol() }}{{ number_format($inc->increment_amount, 2) }}</span>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Percentage
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                New CTC
                                                <span class="fw-bold text-primary">{{ get_currency_symbol() }}{{ number_format($inc->new_ctc, 2) }}</span>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Status
                                                @if($inc->status == 'approved')
                                            ...
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    @if(isset($inc->new_salary_structure['salary']))
                                                        ...
                                                        @foreach($inc->new_salary_structure['salary'] as $comp)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">{{ get_currency_symbol() }}{{ number_format($comp['value'], 2) }}</td>
                                                            </tr>
                                                        @endforeach
                                                    @endif
                                                    @if(isset($inc->new_salary_structure['statutory']))
                                                    ...
                                                    <tr class="table-success fw-bold">
                                                        ...
                                                        <td class="text-end">{{ get_currency_symbol() }}{{ number_format($netSalary, 2) }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
