                            ...
                            <form id="apply_jobs" action="{{ route('form/apply/job/save') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control">
                                        <input type="file" class="form-control-input @error('cv_upload') is-invalid @enderror" id="cv_upload" name="cv_upload">
                                        <label class="form-control-label" for="cv_upload">Choose file</label>
                                    </div>
                                </div>
