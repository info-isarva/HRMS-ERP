                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="metric-value text-warning">{{ get_currency_symbol() }}<span id="grand-total">{{ number_format($totalOtAmount + $totalHolidayAmount, 0) }}</span></h3>
                                </div>
                                <div class="metric-icon">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotals() {
        ...
        document.querySelectorAll('.holiday-total').forEach(cell => {
            totalHoliday += parseFloat(cell.textContent.replace(new RegExp('[\\' + window.globalCurrencySymbol + ',]', 'g'), '')) || 0;
        });

        document.getElementById('total-ot-amount').textContent = window.globalCurrencySymbol + totalOt.toLocaleString(window.globalCurrencyLocale);
        document.getElementById('total-holiday-amount').textContent = window.globalCurrencySymbol + totalHoliday.toLocaleString(window.globalCurrencyLocale);
        document.getElementById('grand-total').textContent = window.globalCurrencySymbol + (totalOt + totalHoliday).toLocaleString(window.globalCurrencyLocale);
    }
});
</script>
