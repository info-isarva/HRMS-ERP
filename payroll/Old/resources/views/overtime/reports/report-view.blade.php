...
@section('title', 'Overtime & Holiday Payout Reports')
                ...
                <div class="page-header-card">
                    <div class="page-header-gradient">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h1 class="page-header-title">Overtime & Holiday Payout Reports</h1>
                                <p class="page-header-subtitle">View and analyze overtime and holiday payout records</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-3 d-flex justify-content-between align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">Overtime & Holiday Payout Reports</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <form action="" method="GET">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-control form-select" name="report_type" onchange="this.form.submit()">
                                <option value="overtime" {{ $report_type === 'overtime' ? 'selected' : '' }}>Overtime</option>
                                <option value="holiday_payout" {{ $report_type === 'holiday_payout' ? 'selected' : '' }}>Holiday Payout</option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label>Month</label>
                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <h3 class="text-primary">{{ number_format($total_hours_or_days, 2) }}</h3>
                            </div>
                            <div class="dash-title">{{ $report_type === 'overtime' ? 'Total OT Hours' : 'Total Holiday Work Days' }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="metric-card">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <h3 class="text-success">{{ number_format($total_amount, 2) }}</h3>
                            </div>
                ...
                <div class="metric-card">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <h3 class="text-info">{{ number_format($avg_hours_or_days, 2) }}</h3>
                            </div>
                            <div class="dash-title">{{ $report_type === 'overtime' ? 'Average OT Hours' : 'Average Holiday Work Days' }}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white !important;">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0 fw-bold">
                                <i class="fa fa-table me-2"></i>{{ $report_type === 'overtime' ? 'Overtime Records' : 'Holiday Payout Records' }}
                            </h4>
                            <div>
                                <a href="{{ route('overtime.reports.export', request()->query()) }}" class="btn btn-outline-light btn-sm" target="_blank">
                            ...
                            <table class="table table-striped custom-table mb-0 datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Month</th>
                                        <th>Year</th>
                                        <th class="text-end">{{ $report_type === 'overtime' ? 'OT Hours' : 'Holiday Work Days' }}</th>
                                        <th class="text-end">{{ $report_type === 'overtime' ? 'Rate/Hour' : 'Rate/Day' }}</th>
                                ...
                                <tbody>
                                    @forelse($records as $record)
                                        <tr>
                                            ...
                                            <td class="text-end">{{ number_format($record->ot_hours, 2) }}</td>
                                            <td class="text-end">{{ number_format($record->ot_rate, 2) }}</td>
