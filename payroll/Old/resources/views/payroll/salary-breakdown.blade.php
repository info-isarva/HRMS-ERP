            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum('totalEarnings'), 2) }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum('totalDeductions'), 2) }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum('netPay'), 2) }}</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum(function($attendance) { return isset($attendance->deductions['advance']['value']) && $attendance->deductions['advance']['applicable'] ? $attendance->deductions['advance']['value'] : 0; }), 2) }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum(function($attendance) { return isset($attendance->deductions[1]['value']) && $attendance->deductions[1]['applicable'] ? $attendance->deductions[1]['value'] : 0; }), 2) }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum(function($attendance) { return isset($attendance->deductions[2]['value']) && $attendance->deductions[2]['applicable'] ? $attendance->deductions[2]['value'] : 0; }), 2) }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="summary-card d-flex align-items-center h-100">
                    ...
                    <div class="min-width-0 flex-grow-1">
                        ...
                        <h4 class="summary-card-value mb-0 text-break"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendances->sum(function($attendance) { return isset($attendance->deductions[4]['value']) && $attendance->deductions[4]['applicable'] ? $attendance->deductions[4]['value'] : 0; }), 2) }}</h4>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="employee-row" 
                                    ...
                                    <td class="earnings-cell text-center {{ isset($attendance->earnings[$component->id]['overridden']) && $attendance->earnings[$component->id]['overridden'] ? 'overridden-value' : '' }}">
                                        ...
                                        @else
                                            <span class="amount">
                                                <span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->earnings[$component->id]['value'] ?? 0, 2) }}
                                    ...
                                    <td class="gross-pay-cell text-center">
                                        <span class="amount-highlight gross"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->totalEarnings, 2) }}</span>
                                    </td>
                                    <td class="epf-cell text-center">
                                        <span class="amount"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->epfWage, 2) }}</span>
                                    </td>
                                    <!-- Deductions Columns -->
                                    @foreach($deductionComponents as $component)
                                    <td class="deductions-cell text-center {{ isset($attendance->deductions[$component->id]['overridden']) && $attendance->deductions[$component->id]['overridden'] ? 'overridden-value' : '' }}">
                                        ...
                                        @else
                                            <span class="amount">
                                                <span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->deductions[$component->id]['value'] ?? 0, 2) }}
                                    ...
                                    @if($hasAdvanceDeductions ?? false)
                                        <td class="deductions-cell text-center">
                                            @if(isset($attendance->deductions['advance']['applicable']) && $attendance->deductions['advance']['applicable'])
                                                <span class="amount"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->deductions['advance']['value'] ?? 0, 2) }}</span>
                                            @else
                                                <span class="not-applicable">N/A</span>
                                            @endif
                                        </td>
                                    ...
                                    <td class="total-deductions-cell text-center">
                                        <span class="amount-highlight deduction"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->totalDeductions, 2) }}</span>
                                    </td>
                                    <td class="net-pay-cell text-center">
                                        <span class="amount-highlight net"><span class="currency-symbol">{{ get_currency_symbol() }}</span>{{ number_format($attendance->netPay, 2) }}</span>
                                    </td>
                        ...
                        <div class="card mb-4" id="advanceDeductionCard" style="display: none;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-warning text-dark" id="advanceDeductionAmount">{{ get_currency_symbol() }}0.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card bg-success text-white mb-3">
                                <div class="card-body p-2 text-center">
                                    ...
                                    <h4 id="modalGrossPay" class="mb-0"><span class="currency-symbol">{{ get_currency_symbol() }}</span>0.00</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card bg-danger text-white mb-3">
                                <div class="card-body p-2 text-center">
                                    ...
                                    <h4 id="modalTotalDeductions" class="mb-0"><span class="currency-symbol">{{ get_currency_symbol() }}</span>0.00</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card text-white mb-3" style="background-color: #3fcce3;">
                                <div class="card-body p-2 text-center">
                                    ...
                                    <h4 id="modalNetPay" class="mb-0"><span class="currency-symbol">{{ get_currency_symbol() }}</span>0.00</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="advance_amount" class="form-label">
                                            <i class="fa fa-money-bill-wave me-1 text-success"></i>Advance Amount *
                                        </label>
                                    ...
                                    <thead class="bg-light sticky-top">
                                        <tr>
                                            <th class="border-0" style="min-width: 100px;">
                                                <i class="fa fa-money-bill-wave me-1 text-success"></i>Amount
                                            </th>
                                            ...
                                            <th class="border-0" style="min-width: 100px;">
                                                <i class="fa fa-money-bill-wave me-1 text-warning"></i>Remaining
                                            </th>
...
<script>
    ...
    function formatCurrency(amount) {
        return window.globalCurrencySymbol + ' ' + parseFloat(amount).toLocaleString(window.globalCurrencyLocale, {
            ...
            if (isApplicable) {
                componentDiv.innerHTML = `
                    ...
                    <div class="form-text small">
                        Default: ${window.globalCurrencySymbol} ${defaultValue.toFixed(2)}
                    ...
                    cards.forEach(card => {
                        ...
                        if (cardTitle === title) {
                            ...
                            if (isCurrency) {
                                ...
                                valueElement.innerHTML = `<span class="currency-symbol">{{ get_currency_symbol() }}</span>${formattedValue}`;
                            } else {
