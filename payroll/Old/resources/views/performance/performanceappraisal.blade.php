                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_customer_experience" name="customer_experience" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_marketing" name="marketing" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_management" name="management" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_administration" name="administration" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Expert / Leader</td>
                                                                            <td>
                                                                                <select id="e_presentation_skill" name="presentation_skill" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Expert / Leader</td>
                                                                            <td>
                                                                                <select id="e_quality_of_work" name="quality_of_work" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Expert / Leader</td>
                                                                            <td>
                                                                                <select id="e_efficiency" name="efficiency" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Beginner</td>
                                                                            <td>
                                                                                <select id="e_integrity" name="integrity" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Beginner</td>
                                                                            <td>
                                                                                <select id="e_professionalism" name="professionalism" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_team_work" name="team_work" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_critical_thinking" name="critical_thinking" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_conflict_management" name="conflict_management" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Intermediate</td>
                                                                            <td>
                                                                                <select id="e_attendance" name="attendance" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="2">Advanced</td>
                                                                            <td>
                                                                                <select id="e_ability_to_meet_deadline" name="ability_to_meet_deadline" class="form-control form-select">
                                                                                    @foreach ($indicator as $indicators )
                                                                                    <option value="{{ $indicators->per_name_list }}">{{ $indicators->per_name_list }}</option>
                                                                                    @endforeach
                                                                                </select>
