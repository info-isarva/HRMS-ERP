...
@section('title', 'Manage Statutory Components')
@section('content')
<style>
    /* Page Header Card */
    .page-header-card {
...
<div class="page-wrapper">
    <div class="content container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <div class="page-header-icon-box">
                            <i class="fas fa-gavel fa-lg" style="color: rgba(255,255,255,0.9);"></i>
                        </div>
                        <div class="ms-3">
                            <h1 class="page-header-title">Statutory Components</h1>
                            <p class="page-header-subtitle">Manage statutory salary components and compliance requirements</p>
                        </div>
                    </div>
                    <!-- Stats Section -->
            ...
            <div class="p-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Statutory Components</li>
                    </ol>
                </nav>
                <div class="d-flex gap-2">
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add_statutory_component">
        ...
        <div class="table-card">
            <div class="table-card-header">
                <h4><i class="fas fa-list me-2"></i>Statutory Components List</h4>
            </div>
                    ...
                    <table class="table table-striped custom-table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <button class="btn-action btn-action-edit me-2 statutoryComponentEdit" data-id="{{ $component->id }}">
    ...
    <!-- Add Statutory Component Modal -->
    <div id="add_statutory_component" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-plus-circle me-2"></i>Add Statutory Component</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('form/statutory-component/save') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
    ...
    <!-- Edit Statutory Component Modal -->
    <div id="edit_statutory_component" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Statutory Component</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span>&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="editForm" method="POST" action="{{ route('form/statutory-component/update') }}">
                        @csrf
...
<script>
    ...
    $(document).ready(function () {
        $(document).on('click', '.statutoryComponentEdit', function (e) {
            e.preventDefault();
            var id = $(this).data('id');

            $.ajax({
                url: `${baseUrl}/form/statutory-component/get/${id}`,
                type: 'GET',
                success: function (response) {
                    ...
                    $('#edit_statutory_component').modal('show');
                },
                error: function () {
