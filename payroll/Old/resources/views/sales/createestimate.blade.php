                                    ...
                                    <table class="table table-hover table-white">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control text-end total" type="text" id="sum_total" name="total" value="0" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="5" class="text-end">Tax</td>
                                                <td>
                                                    <input class="form-control text-end"type="text" id="tax_1" name="tax_1" value="0" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control text-end discount" type="text" id="discount" name="discount" value="10">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="font-size: 16px;width: 230px">
                                                    <input class="form-control text-end" type="text" id="grand_total" name="grand_total" value="$ 0.00" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>                               
