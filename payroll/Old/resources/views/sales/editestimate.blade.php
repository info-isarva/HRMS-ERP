                                    ...
                                    <table class="table table-hover table-white">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control text-end" type="text" id="sum_total" name="total" value="{{$estimatesJoin[0]->total }}" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="5" style="text-align: right">Tax</td>
                                                <td style="text-align: right;width: 230px">
                                                    <input class="form-control text-end" type="text"id="tax_1" name="tax_1" value="{{$estimatesJoin[0]->tax_1 }}" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: right; width: 230px">
                                                    <input class="form-control text-end discount" type="text" id="discount" name="discount" value="{{$estimatesJoin[0]->discount }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="text-align: right; font-weight: bold; font-size: 16px;width: 230px">
                                                    <input class="form-control text-end" type="text" id="grand_total" name="grand_total" value="{{$estimatesJoin[0]->grand_total }}" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>                               
