                    ...
                    <div class="settings-card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('company/settings/save') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 mb-3">
                                        <h6 class="section-header">Tax & Statutory Information</h6>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Company PAN</label>
                                            <input type="text" class="form-control" name="company_pan"
                                                   value="{{ $companySettings->company_pan ?? '' }}"
                                                   placeholder="Enter Company PAN (e.g. ABCDE1234F)">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Company TAN</label>
                                            <input type="text" class="form-control" name="company_tan"
                                                   value="{{ $companySettings->company_tan ?? '' }}"
                                                   placeholder="Enter Company TAN (e.g. ABCD12345E)">
                                        </div>
                                    </div>
                                </div>
