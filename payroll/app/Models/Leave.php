...
class Leave extends Model
{
    ...
    public function applyLeave(Request $request)
    {
        ...
        try {
            ...
            // Check Notice Period Leave Restriction
            if (\App\Models\Setting::getValue('restrict_leave_on_notice', false)) {
                 $employeeToCheck = \App\Models\EmployeeBasicDetail::where('employee_id', $employee_id)->first();
                 if ($employeeToCheck && $employeeToCheck->date_of_resignation) {
                     flash()->error('Cannot apply for leave during notice period.');
