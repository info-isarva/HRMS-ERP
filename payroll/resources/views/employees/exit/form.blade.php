                                                        ...
                                                        <table class="table table-striped mb-0" id="salary_components_table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-right">Prorated (₹)</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <!-- Populated by JS -->
                            ...
                            if (response.salary_breakdown && response.salary_breakdown.length > 0) {
                                $.each(response.salary_breakdown, function(index, comp) {
                                    var row = '<tr>' +
                                        ...
                                        '<td class="text-right">₹ ' + parseFloatSafe(comp.monthly_amount).toFixed(2) + '</td>' +
                                        '<td class="text-right">₹ ' + parseFloatSafe(comp.prorated_amount).toFixed(2) + '</td>' +
                                        '</tr>';
