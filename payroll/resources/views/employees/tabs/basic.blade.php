                       ...
                       <!-- <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="basic[designation]" class="form-control form-select @error('basic.designation') is-invalid @enderror" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="basic[department]" class="form-control form-select @error('basic.department') is-invalid @enderror" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="basic[location_id]" class="form-control form-select select2 @error('basic.location_id') is-invalid @enderror" required>
