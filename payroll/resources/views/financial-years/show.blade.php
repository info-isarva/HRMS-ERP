                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td class="text-end">₹{{ number_format($statistics['payroll_summary']['total_gross']) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Total Deductions</td>
                                            <td class="text-end">₹{{ number_format($statistics['payroll_summary']['total_deductions']) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Total Net Pay</td>
                                            <td class="text-end">₹{{ number_format($statistics['payroll_summary']['total_net']) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Average Monthly Gross</td>
                                            <td class="text-end">₹{{ number_format($statistics['payroll_summary']['average_monthly_gross']) }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
