        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-card">
                    <div class="page-header-gradient">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                <h1 class="page-header-title">Edit Notification</h1>
                                <p class="page-header-subtitle">Modify notification details and settings</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-3 d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('manual-notifications.show', $manualNotification) }}" class="btn btn-outline-info me-2">
                ...
                <div class="settings-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('manual-notifications.update', $manualNotification) }}" method="POST" id="notificationForm">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" 
                                               value="{{ old('title', $manualNotification->title) }}" required maxlength="255" placeholder="Enter notification title">
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="priority" class="form-control form-select @error('priority') is-invalid @enderror" required>
                                            ...
                                            <option value="low" {{ old('priority', $manualNotification->priority) == 'low' ? 'selected' : '' }}>Low</option>
                                            <option value="medium" {{ old('priority', $manualNotification->priority) == 'medium' ? 'selected' : '' }}>Medium</option>
                                            <option value="high" {{ old('priority', $manualNotification->priority) == 'high' ? 'selected' : '' }}>High</option>
                                        </select>
                                        @error('priority')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" class="form-control @error('message') is-invalid @enderror" 
                                                  rows="4" required placeholder="Enter notification message">{{ old('message', $manualNotification->message) }}</textarea>
                                        @error('message')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="target_type" id="target_type" class="form-control form-select @error('target_type') is-invalid @enderror" required>
                                            ...
                                            <option value="all" {{ old('target_type', $manualNotification->target_type) == 'all' ? 'selected' : '' }}>All Employees</option>
                                            <option value="department" {{ old('target_type', $manualNotification->target_type) == 'department' ? 'selected' : '' }}>Specific Department</option>
                                            <option value="specific_employees" {{ old('target_type', $manualNotification->target_type) == 'specific_employees' ? 'selected' : '' }}>Specific Employees</option>
                                        </select>
                                        @error('target_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="target_departments[]" id="target_departments"
                                            ...
                                            @foreach($departments as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ in_array($id, old('target_departments', json_decode($manualNotification->target_departments ?? '[]', true))) ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="target_employees[]" id="target_employees"
                                            ...
                                            @foreach($employees as $employee)
                                                <option value="{{ $employee->id }}"
                                                    {{ in_array($employee->id, old('target_employees', $manualNotification->target_employees ?? [])) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-select @error('status') is-invalid @enderror">
                                            <option value="draft" {{ old('status', $manualNotification->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                                            <option value="scheduled" {{ old('status', $manualNotification->status) == 'scheduled' ? 'selected' : '' }}>Scheduled</option>
                                            <option value="active" {{ old('status', $manualNotification->status) == 'active' ? 'selected' : '' }}>Active Now</option>
                                            <option value="inactive" {{ old('status', $manualNotification->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="start_date"
                                               ...
                                               value="{{ old('start_date', $manualNotification->start_date ? \Carbon\Carbon::parse($manualNotification->start_date)->format('Y-m-d\TH:i') : '') }}">
                                        @error('start_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" name="end_date"
                                               ...
                                               value="{{ old('end_date', $manualNotification->end_date ? \Carbon\Carbon::parse($manualNotification->end_date)->format('Y-m-d\TH:i') : '') }}">
                                        @error('end_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="recurrence_type" class="form-control form-select @error('recurrence_type') is-invalid @enderror">
                                            <option value="once" {{ old('recurrence_type', $manualNotification->recurrence_type ?? 'once') == 'once' ? 'selected' : '' }}>Once</option>
                                            <option value="daily" {{ old('recurrence_type', $manualNotification->recurrence_type) == 'daily' ? 'selected' : '' }}>Daily</option>
                                            <option value="weekly" {{ old('recurrence_type', $manualNotification->recurrence_type) == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                            <option value="monthly" {{ old('recurrence_type', $manualNotification->recurrence_type) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="icon" class="form-control form-select @error('icon') is-invalid @enderror">
                                            <option value="fa-bell" {{ old('icon', $manualNotification->icon ?? 'fa-bell') == 'fa-bell' ? 'selected' : '' }}>🔔 Bell</option>
                                            <option value="fa-info-circle" {{ old('icon', $manualNotification->icon) == 'fa-info-circle' ? 'selected' : '' }}>ℹ️ Info</option>
                                            <option value="fa-exclamation-triangle" {{ old('icon', $manualNotification->icon) == 'fa-exclamation-triangle' ? 'selected' : '' }}>⚠️ Warning</option>
                                            <option value="fa-calendar" {{ old('icon', $manualNotification->icon) == 'fa-calendar' ? 'selected' : '' }}>📅 Calendar</option>
                                            <option value="fa-bullhorn" {{ old('icon', $manualNotification->icon) == 'fa-bullhorn' ? 'selected' : '' }}>📢 Announcement</option>
                                        </select>
                                        @error('icon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="color" class="form-control form-select @error('color') is-invalid @enderror">
                                            <option value="primary" {{ old('color', $manualNotification->color ?? 'primary') == 'primary' ? 'selected' : '' }}>Primary</option>
                                            <option value="success" {{ old('color', $manualNotification->color) == 'success' ? 'selected' : '' }}>Success</option>
                                            <option value="info" {{ old('color', $manualNotification->color) == 'info' ? 'selected' : '' }}>Info</option>
                                            <option value="warning" {{ old('color', $manualNotification->color) == 'warning' ? 'selected' : '' }}>Warning</option>
                                            <option value="danger" {{ old('color', $manualNotification->color) == 'danger' ? 'selected' : '' }}>Danger</option>
                                        </select>
                                        @error('color')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-switch mt-2">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="show_in_header"
                                                   name="show_in_header" value="1" {{ old('show_in_header', $manualNotification->show_in_header) == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-switch mt-2">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="send_email"
                                                   name="send_email" value="1" {{ old('send_email', $manualNotification->send_email) == '1' ? 'checked' : '' }}>
