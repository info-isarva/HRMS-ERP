...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header-card">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <div class="page-header-icon-box">
                            <i class="fas fa-map-marker-alt fa-lg" style="color: rgba(255,255,255,0.9);"></i>
                        </div>
                        <div class="ms-3">
                            <h1 class="page-header-title">Locations</h1>
                            <p class="page-header-subtitle">Manage locations and units</p>
                        </div>
                    </div>
                    <!-- Stats Section -->
                    <div class="d-flex align-items-center text-end d-none d-md-flex">
                        <div class="page-header-stats me-3 text-white">
                            <p class="page-header-stats-label mb-0" style="opacity: 0.9; font-size: 0.875rem;">Total Locations</p>
                            <p class="page-header-stats-value mb-0 fw-bold" style="font-size: 1.75rem;">{{ $locations->count() }}</p>
                        </div>
                        <div class="page-header-stats-icon p-2 rounded" style="background: rgba(255,255,255,0.2); width: auto; height: auto;">
                            <i class="fas fa-map text-white" style="font-size: 2rem;"></i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="p-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex gap-2">
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add_location">
        ...
        <div class="table-card">
            <div class="table-card-header">
                <h4><i class="fas fa-list me-2"></i>Location List</h4>
            </div>
                    ...
                    <table class="table table-striped custom-table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $location->name }}</td>
                                <td>
                                    <span class="badge badge-modern badge-{{ $location->status ? 'success' : 'danger' }}">
                                        {{ $location->status ? 'Active' : 'Inactive' }}
                                    </span>
                                </td>
                                <td class="text-end">
                                    <button class="btn-action btn-action-edit me-2 locationEdit" data-id="{{ $location->id }}">
                                        <i class="fas fa-edit me-1"></i> Edit
                                    </button>
                                    <button class="btn-action btn-action-delete locationDelete" data-id="{{ $location->id }}" data-toggle="modal" data-target="#delete_location">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('form/location/save') }}" method="POST">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="mb-3 text-uppercase bg-light p-2 rounded"><i class="fas fa-info-circle me-2 text-primary"></i>Location Details</h5>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter location name" value="{{ old('name') }}" required>
                                    </div>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('short_name') is-invalid @enderror" name="short_name" placeholder="Enter short name" value="{{ old('short_name') }}">
                                    </div>
                                    @error('short_name')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
    ...
    <div id="edit_location" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST" action="{{ route('form/location/update') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-map-marker-alt"></i></span>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="edit_name" placeholder="Enter location name" value="{{ old('name') }}" required>
                                    </div>
                                    @error('name')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-tag"></i></span>
                                        <input type="text" class="form-control @error('short_name') is-invalid @enderror" name="short_name" id="edit_short_name" placeholder="Enter short name" value="{{ old('short_name') }}">
                                    </div>
                                    @error('short_name')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label class="form-label">Description</label>
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="edit_description" rows="3" placeholder="Enter description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <div id="delete_location" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-trash-alt me-2"></i>Delete Location</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span>&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <p class="text-muted mb-4">This action cannot be undone. This will permanently delete the location.</p>
                        <div class="d-flex justify-content-center gap-3">
                            <form id="deleteForm" method="POST" action="{{ route('form/location/delete') }}" class="d-inline">
                                @csrf
    ...
    @section('script')
        <script>
            ...
            $(document).ready(function () {
                $('.locationEdit').click(function (e) {
                    e.preventDefault();
                    var id = $(this).data('id');

                    $.ajax({
                        url: `${baseUrl}/form/location/get/${id}`,
                        type: 'GET',
                        success: function (response) {
                            console.log('=== LOCATION EDIT DEBUG ===');
