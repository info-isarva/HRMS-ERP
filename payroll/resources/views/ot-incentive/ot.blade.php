                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="metric-value text-warning">₹<span id="grand-total">{{ number_format($totalOtAmount, 0) }}</span></h3>
                                </div>
                                <div class="metric-icon">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotals() {
        ...
        const otEl = document.getElementById('total-ot-amount');
        if (otEl) otEl.textContent = totalOt.toLocaleString('en-IN');

        const holidayEl = document.getElementById('total-holiday-amount');
        if (holidayEl) holidayEl.textContent = totalHoliday.toLocaleString('en-IN');

        const grandEl = document.getElementById('grand-total');
        if (grandEl) grandEl.textContent = (totalOt + totalHoliday).toLocaleString('en-IN');
    }
});
</script>
