                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="summary-card">
                                ...
                                <div class="summary-card-value">₹{{ $previousTotals ? number_format($previousTotals['total_gross_pay'], 0) : 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="summary-card highlight-net-payable">
                                ...
                                <div class="summary-card-value">₹{{ $previousTotals ? number_format($previousTotals['net_payable'], 0) : 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="summary-card">
                                ...
                                <div class="summary-card-value">₹{{ $previousTotals ? number_format($previousTotals['total_deductions'], 0) : 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="summary-card">
                                ...
                                <div class="summary-card-value">₹{{ $previousTotals ? number_format($previousTotals['total_epf'], 0) : 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="summary-card">
                                ...
                                <div class="summary-card-value">₹{{ $previousTotals ? number_format($previousTotals['total_esic'], 0) : 'N/A' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="summary-card current-month">
                                ...
                                <div class="summary-card-label">Gross Pay</div>
                                <div class="summary-card-value-row">
                                    <div class="summary-card-value">₹{{ number_format($currentTotals['total_gross_pay'], 0) }}</div>
                                    @if($previousTotals && $differences['total_gross_pay'] != 0)
                                        <div class="summary-card-change">
                                            <span class="{{ $differences['total_gross_pay'] > 0 ? 'text-success' : 'text-danger' }}">
                                                ...
                                                ₹{{ number_format(abs($differences['total_gross_pay']), 0) }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="summary-card highlight-net-payable current-month" style="box-shadow: 0 6px 20px rgba(59, 130, 246, 0.25);">
                                ...
                                <div class="summary-card-value-row">
                                    <div class="summary-card-value" style="font-size: 1.5rem;">₹{{ number_format($currentTotals['net_payable'], 0) }}</div>
                                    @if($previousTotals && $differences['net_payable'] != 0)
                                        <div class="summary-card-change">
                                            <span class="{{ $differences['net_payable'] > 0 ? 'text-success' : 'text-danger' }}">
                                                ...
                                                ₹{{ number_format(abs($differences['net_payable']), 0) }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="summary-card current-month">
                                ...
                                <div class="summary-card-label">Total Deductions</div>
                                <div class="summary-card-value-row">
                                    <div class="summary-card-value">₹{{ number_format($currentTotals['total_deductions'], 0) }}</div>
                                    @if($previousTotals && $differences['total_deductions'] != 0)
                                        <div class="summary-card-change">
                                            <span class="{{ $differences['total_deductions'] > 0 ? 'text-danger' : 'text-success' }}">
                                                ...
                                                ₹{{ number_format(abs($differences['total_deductions']), 0) }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="summary-card current-month">
                                ...
                                <div class="summary-card-label">EPF</div>
                                <div class="summary-card-value-row">
                                    <div class="summary-card-value">₹{{ number_format($currentTotals['total_epf'], 0) }}</div>
                                    @if($previousTotals && $differences['total_epf'] != 0)
                                        <div class="summary-card-change">
                                            <span class="{{ $differences['total_epf'] > 0 ? 'text-danger' : 'text-success' }}">
                                                ...
                                                ₹{{ number_format(abs($differences['total_epf']), 0) }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="summary-card current-month">
                                ...
                                <div class="summary-card-label">ESIC</div>
                                <div class="summary-card-value-row">
                                    <div class="summary-card-value">₹{{ number_format($currentTotals['total_esic'], 0) }}</div>
                                    @if($previousTotals && $differences['total_esic'] != 0)
                                        <div class="summary-card-change">
                                            <span class="{{ $differences['total_esic'] > 0 ? 'text-danger' : 'text-success' }}">
                                                ...
                                                ₹{{ number_format(abs($differences['total_esic']), 0) }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
