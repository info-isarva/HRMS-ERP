...
@section('title', 'Edit Salary Hold')
@section('content')

<style>
    /* Reuse styles from create.blade.php or master CSS */
    .page-header-card {
        background: white;
        border-radius: 1rem;
...
<div class="page-wrapper">
    <div class="content container-fluid">
            ...
            <div class="page-header-gradient">
                ...
                <div class="d-flex align-items-center">
                    <div class="page-header-icon-box">
                        <i class="fas fa-edit fa-lg" style="color: rgba(255,255,255,0.9);"></i>
                    </div>
                    <div class="ms-3">
                        <h1 class="page-header-title">Edit Salary Hold</h1>
                        <p class="page-header-subtitle">Update hold details for {{ $hold->employee->name }}</p>
                    </div>
                </div>
            </div>
            <div class="p-3 d-flex justify-content-between align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Edit Hold</li>
                    </ol>
                </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-card">
                    <form action="{{ route('hold-salary.update', $hold->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $hold->employee->name }} ({{ $hold->employee->employee_id }})" readonly disabled>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="hold_type" id="hold_type" class="form-select" required>
                                    <option value="month" {{ $hold->hold_type == 'month' ? 'selected' : '' }}>For One Month</option>
                                    <option value="indefinite" {{ $hold->hold_type == 'indefinite' ? 'selected' : '' }}>Indefinite (Till Manual Release)</option>
                                </select>
                            </div>

                            <div class="col-md-6 mb-3" id="month_wrapper">
                                <label class="form-label">Payout Month <span class="text-danger">*</span></label>
                                <input type="month" name="payout_month_year" class="form-control" 
                                       value="{{ $hold->payout_month ? sprintf('%d-%02d', $hold->payout_year, $hold->payout_month) : '' }}">
                                <div class="form-text">The salary for this specific month will be held.</div>
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="form-label">Remarks</label>
                                <textarea name="remarks" class="form-control" rows="4">{{ $hold->remarks }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i> Update Hold
                            </button>
                        </div>
                    </form>
                </div>
