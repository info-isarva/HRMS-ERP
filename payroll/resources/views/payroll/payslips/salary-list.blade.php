                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-3">
                        <div class="stat-card">
                            ...
                            <div class="stat-value">₹{{ number_format($attendances->sum('totalEarnings'), 0) }}</div>
                    ...
                    <div class="col-md-3">
                        <div class="stat-card">
                            ...
                            <div class="stat-value">₹{{ number_format($attendances->sum('totalDeductions'), 0) }}</div>
                    ...
                    <div class="col-md-3">
                        <div class="stat-card">
                            ...
                            <div class="stat-value">₹{{ number_format($attendances->sum('netPay'), 0) }}</div>
                                ...
                                <tr class="employee-row" 
                                    ...
                                    <!-- @foreach($earningComponents as $component)
                                        <td class="earnings-cell text-center">
                                            ...
                                            @else
                                                <span class="amount">₹{{ number_format($attendance->earnings[$component->id]['value'], 2) }}</span>
                                            @endif
                                        </td>
                                    @endforeach -->
                                    
                                    <td class="gross-pay-cell text-center">
                                        <span class="amount-highlight gross">₹{{ number_format($attendance->totalEarnings, 2) }}</span>
                                    </td>
                                    
                                    <!-- <td class="epf-cell text-center">
                                        <span class="amount">₹{{ number_format($attendance->epfWage, 2) }}</span>
                                    </td> -->
                                    ...
                                    <!-- @foreach($deductionComponents as $component)
                                        <td class="deductions-cell text-center">
                                            @if(isset($attendance->deductions[$component->id]['applicable']) && !$attendance->deductions[$component->id]['applicable'])
                                                <span class="not-applicable">N/A</span>
                                            @else
                                                <span class="amount">₹{{ number_format($attendance->deductions[$component->id]['value'], 2) }}</span>
                                            @endif
                                        </td>
                                    @endforeach -->
                                    
                                    <td class="total-deductions-cell text-center">
                                        <span class="amount-highlight deduction">₹{{ number_format($attendance->totalDeductions, 2) }}</span>
                                    </td>
                                    
                                    <td class="net-pay-cell text-center">
                                        <span class="amount-highlight net">₹{{ number_format($attendance->netPay, 2) }}</span>
                                    </td>
...
<script>
    ...
    document.querySelectorAll('.btn-outline-primary').forEach(btn => {
     ...
     function openAdjustSalaryModal(attendanceId, employeeId) {
        ...
        // document.getElementById('modalGrossPay').textContent = '₹' + employeeData.gross_pay.toFixed(2);
        // document.getElementById('modalTotalDeductions').textContent = '₹' + employeeData.total_deductions.toFixed(2);
        document.getElementById('modalNetPay').textContent = '₹  ' + numberFormat(employeeData.net_pay, 2);
        document.getElementById('wordNetPay').textContent =  numberToWords(employeeData.net_pay) + ' Rupees Only';
    ...
    function renderComponents(containerId, components,deductions, totalEarning, totalDeduction, type) {
        ...
        if(maxRows > 0) {
            ...
            componentDiv1.innerHTML = `
                ...
                <td><strong>${'₹ ' + totalEarning}</strong></td>
