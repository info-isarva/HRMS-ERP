            ...
            <div class="col-md-3">
                <div class="card bg-success text-white">
                    <div class="card-body text-center">
                        ...
                        <h4>₹{{ number_format($salaryBreakdown['summary']['total_gross_salary'], 2) }}</h4>
            ...
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body text-center">
                        ...
                        <h4>₹{{ number_format($salaryBreakdown['summary']['total_deductions'], 2) }}</h4>
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white">
                    <div class="card-body text-center">
                        ...
                        <h4>₹{{ number_format($salaryBreakdown['summary']['total_net_salary'], 2) }}</h4>
            ...
            <div class="col-md-3">
                <div class="card border-left-success">
                    <div class="card-body text-center">
                        ...
                        <h5>₹{{ number_format($salaryBreakdown['summary']['total_incentives'], 2) }}</h5>
                        ...
                        <tbody>
                            @foreach($salaryBreakdown['employees'] as $employee)
                                <tr>
                                    ...
                                    <td>
                                        <small>
                                            HRA: ₹{{ number_format($employee->hra_amount ?? 0, 2) }}<br>
                                            Transport: ₹{{ number_format($employee->transport_allowance ?? 0, 2) }}<br>
                                            Other: ₹{{ number_format($employee->other_allowance ?? 0, 2) }}
                                        </small>
                                    </td>
                                    <td><strong>₹{{ number_format($employee->gross_salary, 2) }}</strong></td>
                                    <td>
                                        <small>
                                            PF: ₹{{ number_format($employee->pf_deduction ?? 0, 2) }}<br>
                                            ESI: ₹{{ number_format($employee->esi_deduction ?? 0, 2) }}<br>
                                            Tax: ₹{{ number_format($employee->tax_deduction ?? 0, 2) }}<br>
                                            Other: ₹{{ number_format($employee->other_deductions ?? 0, 2) }}
                                        </small>
                                    </td>
                                    <td><strong class="text-success">₹{{ number_format($employee->net_salary, 2) }}</strong></td>
                                    <td>
                                        {{ $employee->overtime_hours ?? 0 }} hrs<br>
                                        <small>₹{{ number_format($employee->overtime_amount ?? 0, 2) }}</small>
                                    </td>
                                    <td>₹{{ number_format($employee->incentive_amount ?? 0, 2) }}</td>
                                    <td>
