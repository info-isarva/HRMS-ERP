                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body text-center">
                            ...
                            <h4>₹${numberFormat(data.summary.total_gross_salary)}</h4>
                ...
                <div class="col-md-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body text-center">
                            ...
                            <h4>₹${numberFormat(data.summary.total_deductions)}</h4>
                ...
                <div class="col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body text-center">
                            ...
                            <h4>₹${numberFormat(data.summary.total_net_salary)}</h4>
        ...
        data.employees.forEach(function(employee) {
            html += `
                <tr>
                    ...
                    <td>₹${numberFormat(employee.basic_salary)}</td>
                    <td>₹${numberFormat(employee.gross_salary)}</td>
                    <td>₹${numberFormat(employee.total_deductions)}</td>
                    <td><strong>₹${numberFormat(employee.net_salary)}</strong></td>
                    <td>
                        ${employee.overtime_hours || 0} hrs<br>
                        <small>₹${numberFormat(employee.overtime_amount || 0)}</small>
                    </td>
                    <td>₹${numberFormat(employee.incentive_amount || 0)}</td>
