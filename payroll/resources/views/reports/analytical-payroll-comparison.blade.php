                    ...
                    <div class="settings-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="metric-card">
                                        <div class="metric-value text-success">₹{{ number_format($latestMonth['gross_pay']) }}</div>
                                        <div class="metric-label">Gross Pay</div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="metric-card">
                                        <div class="metric-value text-warning">₹{{ number_format($latestMonth['total_deductions']) }}</div>
                                        <div class="metric-label">Total Deductions</div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="metric-card">
                                        <div class="metric-value text-info">₹{{ number_format($latestMonth['net_pay']) }}</div>
                                    ...
                                    <tbody>
                                        @foreach($monthlyData as $monthKey => $month)
                                            <tr>
                                                ...
                                                <td>₹{{ number_format($month['gross_pay']) }}</td>
                                                <td>₹{{ number_format($month['epf']) }}</td>
                                                <td>₹{{ number_format($month['esi']) }}</td>
                                                <td>₹{{ number_format($month['pt']) }}</td>
                                                <td>₹{{ number_format($month['tds']) }}</td>
                                                <td>₹{{ number_format($month['advance']) }}</td>
                                                <td>₹{{ number_format($month['total_deductions']) }}</td>
                                                <td>₹{{ number_format($month['net_pay']) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="metric-card">
                                                                <div class="metric-value {{ $comparison['gross_pay']['is_increase'] ? 'gross-increase' : 'gross-decrease' }}">
                                                                    ₹{{ number_format($comparison['gross_pay']['current']) }}
                                                                </div>
                                                                <div class="metric-label">Gross Pay</div>
                                                                <div class="value-display">
                                                                    Previous: ₹{{ number_format($comparison['gross_pay']['previous']) }}
                                                                    | Diff: ₹{{ $comparison['gross_pay']['difference'] > 0 ? '+' : '' }}{{ number_format($comparison['gross_pay']['difference']) }}
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 col-12 mb-3 mb-md-0">
                                                            <div class="metric-card">
                                                                <div class="metric-value {{ $comparison['total_deductions']['is_increase'] ? 'deduction-increase' : 'deduction-decrease' }}">
                                                                    ₹{{ number_format($comparison['total_deductions']['current']) }}
                                                                </div>
                                                                <div class="metric-label">Total Deductions</div>
                                                                <div class="value-display">
                                                                    Previous: ₹{{ number_format($comparison['total_deductions']['previous']) }}
                                                                    | Diff: ₹{{ $comparison['total_deductions']['difference'] > 0 ? '+' : '' }}{{ number_format($comparison['total_deductions']['difference']) }}
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="metric-card">
                                                                <div class="metric-value {{ $comparison['net_pay']['is_increase'] ? 'net-increase' : 'net-decrease' }}">
                                                                    ₹{{ number_format($comparison['net_pay']['current']) }}
                                                                </div>
                                                                <div class="metric-label">Net Pay</div>
                                                                <div class="value-display">
                                                                    Previous: ₹{{ number_format($comparison['net_pay']['previous']) }}
                                                                    | Diff: ₹{{ $comparison['net_pay']['difference'] > 0 ? '+' : '' }}{{ number_format($comparison['net_pay']['difference']) }}
                                                                </div>
                                                    ...
                                                    <div class="component-grid">
                                                        <div class="component-item">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="value-display">
                                                                    ₹{{ number_format($comparison['epf']['current']) }} vs ₹{{ number_format($comparison['epf']['previous']) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="component-item">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="value-display">
                                                                    ₹{{ number_format($comparison['esi']['current']) }} vs ₹{{ number_format($comparison['esi']['previous']) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="component-item">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="value-display">
                                                                    ₹{{ number_format($comparison['pt']['current']) }} vs ₹{{ number_format($comparison['pt']['previous']) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="component-item">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="value-display">
                                                                    ₹{{ number_format($comparison['tds']['current']) }} vs ₹{{ number_format($comparison['tds']['previous']) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="component-item">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="value-display">
                                                                    ₹{{ number_format($comparison['advance']['current']) }} vs ₹{{ number_format($comparison['advance']['previous']) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        comparisons.forEach((comparison, index) => {
            ...
            if (comparisonCtx) {
                new Chart(comparisonCtx, {
                    type: 'bar',
                    data: {
                        labels: ['Gross Pay (₹)', 'Total Deductions (₹)', 'Net Pay (₹)'],
                        datasets: [
                            {
