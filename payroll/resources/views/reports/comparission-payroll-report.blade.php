                ...
                <div class="settings-card">
                    ...
                    <div class="card-body d-flex flex-wrap justify-content-between">
                        ...
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            ...
                            <div class="h4 mb-0 text-success fw-bold">₹{{ number_format($comparisonData['totals']['first_month']['gross_pay'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                            ...
                            <div class="h4 mb-0 fw-bold" style="color: #3fcce3;">₹{{ number_format($comparisonData['totals']['first_month']['net_pay'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                            ...
                            <div class="h4 mb-0 text-danger fw-bold">₹{{ number_format($comparisonData['totals']['first_month']['total_deductions'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                            ...
                            <div class="h4 mb-0 fw-bold" style="color: #20c997;">₹{{ number_format($comparisonData['totals']['first_month']['epf'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                            ...
                            <div class="h4 mb-0 text-info fw-bold">₹{{ number_format($comparisonData['totals']['first_month']['esic'], 0) }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="settings-card">
                    ...
                    <div class="card-body d-flex flex-wrap justify-content-between">
                        ...
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            ...
                            <div class="h4 mb-0 text-success fw-bold">₹{{ number_format($comparisonData['totals']['second_month']['gross_pay'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                                <i class="fa fa-calculator fa-lg me-1" style="color: #3fcce3;"></i>
                            ...
                            <div class="h4 mb-0 fw-bold" style="color: #3fcce3;">₹{{ number_format($comparisonData['totals']['second_month']['net_pay'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                                <i class="fa fa-minus-circle fa-lg me-1 text-danger"></i>
                            ...
                            <div class="h4 mb-0 text-danger fw-bold">₹{{ number_format($comparisonData['totals']['second_month']['total_deductions'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                                <i class="fa fa-id-card fa-lg me-1" style="color: #20c997;"></i>
                            ...
                            <div class="h4 mb-0 fw-bold" style="color: #20c997;">₹{{ number_format($comparisonData['totals']['second_month']['epf'], 0) }}</div>
                        </div>
                        <div class="p-4 text-center flex-fill" style="min-width: 150px;">
                            <div class="text-muted mb-2">
                                <i class="fa fa-heartbeat fa-lg me-1 text-info"></i>
                            ...
                            <div class="h4 mb-0 text-info fw-bold">₹{{ number_format($comparisonData['totals']['second_month']['esic'], 0) }}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body text-center p-4 text-white">
                        ...
                        <div class="h5 mb-0 fw-bold">
                            @if($comparisonData['summary']['gross_pay_change'] >= 0)
                                <i class="fa fa-arrow-up me-1"></i>₹{{ number_format(abs($comparisonData['summary']['gross_pay_change']), 0) }}
                            @else
                                <i class="fa fa-arrow-down me-1"></i>₹{{ number_format(abs($comparisonData['summary']['gross_pay_change']), 0) }}
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body text-center p-4 text-white">
                        ...
                        <div class="h5 mb-0 fw-bold">
                            @if($comparisonData['summary']['net_pay_change'] >= 0)
                                <i class="fa fa-arrow-up me-1"></i>₹{{ number_format(abs($comparisonData['summary']['net_pay_change']), 0) }}
                            @else
                                <i class="fa fa-arrow-down me-1"></i>₹{{ number_format(abs($comparisonData['summary']['net_pay_change']), 0) }}
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body text-center p-4 text-white">
                        ...
                        <div class="h5 mb-0 fw-bold">
                            @if($comparisonData['summary']['deduction_change'] >= 0)
                                <i class="fa fa-arrow-up me-1"></i>₹{{ number_format(abs($comparisonData['summary']['deduction_change']), 0) }}
                            @else
                                <i class="fa fa-arrow-down me-1"></i>₹{{ number_format(abs($comparisonData['summary']['deduction_change']), 0) }}
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body text-center p-4 text-white">
                        ...
                        <div class="h5 mb-0 fw-bold">
                            @if($comparisonData['summary']['epf_change'] >= 0)
                                <i class="fa fa-arrow-up me-1"></i>₹{{ number_format(abs($comparisonData['summary']['epf_change']), 0) }}
                            @else
                                <i class="fa fa-arrow-down me-1"></i>₹{{ number_format(abs($comparisonData['summary']['epf_change']), 0) }}
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body text-center p-4 text-white">
                        ...
                        <div class="h5 mb-0 fw-bold">
                            @if($comparisonData['summary']['esic_change'] >= 0)
                                <i class="fa fa-arrow-up me-1"></i>₹{{ number_format(abs($comparisonData['summary']['esic_change']), 0) }}
                            @else
                                <i class="fa fa-arrow-down me-1"></i>₹{{ number_format(abs($comparisonData['summary']['esic_change']), 0) }}
                            @endif
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table mb-0" id="comparisonTable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle hover-row">
                                        ...
                                        @else
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['first_month']['gross_pay'], 0) }}</td>
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['first_month']['epf'], 0) }}</td>
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['first_month']['esic'], 0) }}</td>
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['first_month']['total_deductions'], 0) }}</td>
                                            <td class="text-center border-end fw-bold text-success">₹{{ number_format($employee['first_month']['net_pay'], 0) }}</td>
                                        @endif
                                        <!-- Second Month Data -->
                                        ...
                                        @else
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['second_month']['gross_pay'], 0) }}</td>
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['second_month']['epf'], 0) }}</td>
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['second_month']['esic'], 0) }}</td>
                                            <td class="text-center fw-semibold">₹{{ number_format($employee['second_month']['total_deductions'], 0) }}</td>
                                            <td class="text-center border-end fw-bold text-success">₹{{ number_format($employee['second_month']['net_pay'], 0) }}</td>
                                        @endif
                                        <!-- Changes -->
                                        @if($employee['first_month']['status'] == 'not_joined')
                                        ...
                                        @else
                                            <td class="text-center">
                                                ...
                                                <span class="badge badge-lg {{ $grossChange >= 0 ? 'bg-success' : 'bg-danger' }}">
                                                    {{ $grossChange >= 0 ? '+' : '' }}₹{{ number_format($grossChange, 0) }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <span class="badge badge-lg {{ $epfChange >= 0 ? 'bg-warning' : 'bg-info' }}">
                                                    {{ $epfChange >= 0 ? '+' : '' }}₹{{ number_format($epfChange, 0) }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <span class="badge badge-lg {{ $esicChange >= 0 ? 'bg-warning' : 'bg-info' }}">
                                                    {{ $esicChange >= 0 ? '+' : '' }}₹{{ number_format($esicChange, 0) }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <span class="badge badge-lg {{ $deductionChange >= 0 ? 'bg-warning' : 'bg-info' }}">
                                                    {{ $deductionChange >= 0 ? '+' : '' }}₹{{ number_format($deductionChange, 0) }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                ...
                                <tfoot class="table-dark">
                                    <tr class="fw-bold">
                                        ...
                                        <td class="text-center" style="background-color: #007bff; color: white;">₹{{ number_format($comparisonData['totals']['first_month']['gross_pay'], 0) }}</td>
                                        <td class="text-center" style="background-color: #007bff; color: white;">₹{{ number_format($comparisonData['totals']['first_month']['epf'], 0) }}</td>
                                        <td class="text-center" style="background-color: #007bff; color: white;">₹{{ number_format($comparisonData['totals']['first_month']['esic'], 0) }}</td>
                                        <td class="text-center" style="background-color: #007bff; color: white;">₹{{ number_format($comparisonData['totals']['first_month']['total_deductions'], 0) }}</td>
                                        <td class="text-center border-end" style="background-color: #007bff; color: white;">₹{{ number_format($comparisonData['totals']['first_month']['net_pay'], 0) }}</td>
                                        <td class="text-center" style="background-color: #17a2b8; color: white;">₹{{ number_format($comparisonData['totals']['second_month']['gross_pay'], 0) }}</td>
                                        <td class="text-center" style="background-color: #17a2b8; color: white;">₹{{ number_format($comparisonData['totals']['second_month']['epf'], 0) }}</td>
                                        <td class="text-center" style="background-color: #17a2b8; color: white;">₹{{ number_format($comparisonData['totals']['second_month']['esic'], 0) }}</td>
                                        <td class="text-center" style="background-color: #17a2b8; color: white;">₹{{ number_format($comparisonData['totals']['second_month']['total_deductions'], 0) }}</td>
                                        <td class="text-center border-end" style="background-color: #17a2b8; color: white;">₹{{ number_format($comparisonData['totals']['second_month']['net_pay'], 0) }}</td>
                                        <td class="text-center" style="background-color: #28a745; color: white;">₹{{ number_format($comparisonData['summary']['gross_pay_change'], 0) }}</td>
                                        <td class="text-center" style="background-color: #28a745; color: white;">₹{{ number_format($comparisonData['summary']['epf_change'], 0) }}</td>
                                        <td class="text-center" style="background-color: #28a745; color: white;">₹{{ number_format($comparisonData['summary']['esic_change'], 0) }}</td>
                                        <td class="text-center" style="background-color: #28a745; color: white;">₹{{ number_format($comparisonData['summary']['deduction_change'], 0) }}</td>
                                        <td class="text-center" style="background-color: #28a745; color: white;">₹{{ number_format($comparisonData['summary']['net_pay_change'], 0) }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
