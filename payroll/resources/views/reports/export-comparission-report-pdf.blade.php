...
<body>
            ...
            <div class="month-card">
                ...
                <div class="month-stats clearfix">
                    ...
                    <div class="month-stat">
                        ...
                        <div class="value">₹{{ number_format($comparisonData['totals']['first_month']['gross_pay'], 0) }}</div>
                    </div>
                    <div class="month-stat">
                        <div class="label">Net Pay</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['first_month']['net_pay'], 0) }}</div>
                    </div>
                </div>
                <div class="month-stats clearfix" style="margin-top: 10px;">
                    <div class="month-stat">
                        <div class="label">EPF</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['first_month']['epf'], 0) }}</div>
                    </div>
                    <div class="month-stat">
                        <div class="label">ESIC</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['first_month']['esic'], 0) }}</div>
                    </div>
                    <div class="month-stat">
                        <div class="label">Deductions</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['first_month']['total_deductions'], 0) }}</div>
                    </div>
                </div>
            </div>
            <div class="month-card">
                ...
                <div class="month-stats clearfix">
                    ...
                    <div class="month-stat">
                        <div class="label">Gross Pay</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['second_month']['gross_pay'], 0) }}</div>
                    </div>
                    <div class="month-stat">
                        <div class="label">Net Pay</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['second_month']['net_pay'], 0) }}</div>
                    </div>
                </div>
                <div class="month-stats clearfix" style="margin-top: 10px;">
                    <div class="month-stat">
                        <div class="label">EPF</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['second_month']['epf'], 0) }}</div>
                    </div>
                    <div class="month-stat">
                        <div class="label">ESIC</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['second_month']['esic'], 0) }}</div>
                    </div>
                    <div class="month-stat">
                        <div class="label">Deductions</div>
                        <div class="value">₹{{ number_format($comparisonData['totals']['second_month']['total_deductions'], 0) }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="summary-section">
        ...
        <div class="summary-cards clearfix">
            ...
            <div class="summary-card">
                <h3>Gross Pay</h3>
                <div class="value">{{ $comparisonData['summary']['gross_pay_change'] >= 0 ? '+' : '' }}₹{{ number_format(abs($comparisonData['summary']['gross_pay_change']), 0) }}</div>
            </div>
            <div class="summary-card">
                <h3>EPF</h3>
                <div class="value">{{ $comparisonData['summary']['epf_change'] >= 0 ? '+' : '' }}₹{{ number_format(abs($comparisonData['summary']['epf_change']), 0) }}</div>
            </div>
            <div class="summary-card">
                <h3>ESIC</h3>
                <div class="value">{{ $comparisonData['summary']['esic_change'] >= 0 ? '+' : '' }}₹{{ number_format(abs($comparisonData['summary']['esic_change']), 0) }}</div>
            </div>
            <div class="summary-card">
                <h3>Deductions</h3>
                <div class="value">{{ $comparisonData['summary']['deduction_change'] >= 0 ? '+' : '' }}₹{{ number_format(abs($comparisonData['summary']['deduction_change']), 0) }}</div>
            </div>
            <div class="summary-card">
                <h3>Net Pay</h3>
                <div class="value">{{ $comparisonData['summary']['net_pay_change'] >= 0 ? '+' : '' }}₹{{ number_format(abs($comparisonData['summary']['net_pay_change']), 0) }}</div>
            </div>
        </div>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                @else
                    <td>₹{{ number_format($employee['first_month']['gross_pay'], 0) }}</td>
                    <td>₹{{ number_format($employee['first_month']['epf'], 0) }}</td>
                    <td>₹{{ number_format($employee['first_month']['esic'], 0) }}</td>
                    <td>₹{{ number_format($employee['first_month']['total_deductions'], 0) }}</td>
                    <td>₹{{ number_format($employee['first_month']['net_pay'], 0) }}</td>
                @endif
                ...
                @else
                    <td>₹{{ number_format($employee['second_month']['gross_pay'], 0) }}</td>
                    <td>₹{{ number_format($employee['second_month']['epf'], 0) }}</td>
                    <td>₹{{ number_format($employee['second_month']['esic'], 0) }}</td>
                    <td>₹{{ number_format($employee['second_month']['total_deductions'], 0) }}</td>
                    <td>₹{{ number_format($employee['second_month']['net_pay'], 0) }}</td>
                @endif
        ...
        <tfoot>
            <tr class="totals-row">
                ...
                <td><strong>₹{{ number_format($comparisonData['totals']['first_month']['gross_pay'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['first_month']['epf'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['first_month']['esic'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['first_month']['total_deductions'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['first_month']['net_pay'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['second_month']['gross_pay'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['second_month']['epf'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['second_month']['esic'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['second_month']['total_deductions'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['totals']['second_month']['net_pay'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['summary']['gross_pay_change'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['summary']['epf_change'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['summary']['esic_change'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['summary']['deduction_change'], 0) }}</strong></td>
                <td><strong>₹{{ number_format($comparisonData['summary']['net_pay_change'], 0) }}</strong></td>
            </tr>
        </tfoot>
    </table>
