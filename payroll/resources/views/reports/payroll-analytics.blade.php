        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card">
                    ...
                    <div class="stats-value">₹{{ number_format($analytics['gross_total']/100000,1) }}L</div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card">
                    ...
                    <div class="stats-value">₹{{ number_format($analytics['deduction_total']/100000,1) }}L</div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card">
                    ...
                    <div class="stats-value">₹{{ number_format($analytics['net_total']/100000,1) }}L</div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card">
                    ...
                    <div class="stats-value">₹{{ number_format($analytics['avg_gross']) }}</div>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card">
                    ...
                    <div class="stats-value">₹{{ number_format($analytics['avg_net']) }}</div>
                            ...
                            <table id="componentTable" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-end"><i class="fa fa-rupee-sign me-1"></i>Amount</th>
