                        ...
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <h3 class="{{ $comparison['gross_diff']>=0 ? 'text-success':'text-danger' }}">
                                    ₹{{ number_format(abs($comparison['gross_diff'])) }}
                                </h3>
                            </div>
                        ...
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <h3 class="{{ $comparison['net_diff']>=0 ? 'text-success':'text-danger' }}">
                                    ₹{{ number_format(abs($comparison['net_diff'])) }}
                                </h3>
                            </div>
                        ...
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-count">
                                <h3 class="{{ $comparison['deduction_diff']<=0 ? 'text-success':'text-warning' }}">
                                    ₹{{ number_format(abs($comparison['deduction_diff'])) }}
                                </h3>
                            </div>
                                ...
                                <tbody>
                                    @foreach($comparison['components'] as $id => $row)
                                        <tr>
                                            ...
                                            <td class="text-end">₹{{ number_format($row['base_earnings'],2) }}</td>
                                            <td class="text-end">₹{{ number_format($row['next_earnings'],2) }}</td>
                                            <td class="text-end {{ $row['earnings_diff']>=0 ? 'text-success':'text-danger' }}">
                                                <strong>{{ $row['earnings_diff']>=0 ? '+':'' }}₹{{ number_format($row['earnings_diff'],2) }}</strong>
                                            </td>
                                            <td class="text-end text-warning">₹{{ number_format($row['base_deductions'],2) }}</td>
                                            <td class="text-end text-warning">₹{{ number_format($row['next_deductions'],2) }}</td>
                                            <td class="text-end {{ $row['deductions_diff']<=0 ? 'text-success':'text-danger' }}">
                                                <strong>{{ $row['deductions_diff']>=0 ? '+':'' }}₹{{ number_format($row['deductions_diff'],2) }}</strong>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
