...
<body>
    ...
    @if(count($monthlyData) > 0)
        ...
        <div class="summary-cards">
            ...
            <div class="summary-card">
                <div class="card-value currency">Rs {{ number_format($totalGrossPay, 0) }}</div>
                <div class="card-label">Total Gross Pay</div>
            </div>
            <div class="summary-card">
                <div class="card-value currency">Rs {{ number_format($totalDeductions, 0) }}</div>
                <div class="card-label">Total Deductions</div>
            </div>
            <div class="summary-card">
                <div class="card-value currency">Rs {{ number_format($totalNetPay, 0) }}</div>
        ...
        <table class="comparison-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 15%;">Gross Pay (Rs)</th>
                    <th style="width: 12%;">EPF (Rs)</th>
                    <th style="width: 12%;">ESI (Rs)</th>
                    <th style="width: 12%;">PT (Rs)</th>
                    <th style="width: 12%;">TDS (Rs)</th>
                    <th style="width: 10%;">Net Pay (Rs)</th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="footer-note">
        ...
        <p>All monetary values are in Indian Rupees (Rs). Positive changes are shown in green, negative changes in red.</p>
    </div>
</body>
</html>