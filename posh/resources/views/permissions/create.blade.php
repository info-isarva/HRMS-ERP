        ...
        <form method="POST" action="{{ route('permissions.store') }}">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="guard_name" name="guard_name" value="{{ old('guard_name') }}"  readonly>
                    @error('guard_name')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" id="crm_permission" name="crm_permission" value="1" {{ old('crm_permission') ? 'checked' : '' }}> Yes
                </div>
            </div>
